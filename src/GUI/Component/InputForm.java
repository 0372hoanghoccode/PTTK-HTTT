...
public final class InputForm extends JPanel {
    ...
    public InputForm() {
        initialize("", "text", 100, 100);
    }

    public InputForm(String title) {
        initialize(title, "text", 100, 100);
    }

    public InputForm(String title, String style) {
        initialize(title, style, 100, 100);
    }

    public InputForm(String title, int w, int h) {
        initialize(title, "text", w, h);
    }

    private void initialize(String title, String style, int w, int h) {
